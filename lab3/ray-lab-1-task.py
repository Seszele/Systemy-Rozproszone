...
# ray.init(address="ray://ray-head:10001", logging_level=logging.ERROR)
...
arr = ray.get(obj_ref_arr1)
print("local bubble sort")
cProfile.run("run_local_bubble_sort(arr)")

print("remote bubble sort")
cProfile.run("run_remote_bubble_sort(arr)")
